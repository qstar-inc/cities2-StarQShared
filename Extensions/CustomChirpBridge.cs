...
namespace StarQ.Shared.Extensions
{
    ...
    public static class CustomChirpsBridge
    {
        ...
        public static bool IsAvailable
        {
            ...
            {
                EnsureResolve();
                return _apiType != null && _deptEnumType != null && _postChirp != null;
            }
        }
        ...
        /// Post a chirp
        /// </summary>
        public static bool PostChirp(
            string text,
            DepartmentAccountBridge department,
            Entity entity,
        ...
        private static object MapDepartment(DepartmentAccountBridge department)
        {
            ...
            {
                EnsureResolve();
                if (_deptEnumType == null)
                    return "LivingStandardsAssociation"; // dead fallback, won't be used if API present
                return Enum.Parse(_deptEnumType, department.ToString(), ignoreCase: false);
            }
            catch
            {
                return Enum.Parse(_deptEnumType, "LivingStandardsAssociation", ignoreCase: true);
            }
        }
        ...
        private static PrefabBase TryGetPrefabBase(Entity prefabEntity)
        {
            ...
            return prefabSystem.TryGetPrefab<PrefabBase>(pd, out var basePrefab)
                ? basePrefab
                : null;
        }
        ...
        private static void EnsureResolve()
        {
            ...
            _deptEnumType =
                Type.GetType("CustomChirps.Systems.DepartmentAccount, CustomChirps")
                ?? FindType("CustomChirps.Systems.DepartmentAccount");

            if (_apiType != null)
            {
                _postChirp = _apiType.GetMethod(
                    "PostChirp",
